...
public:
	...
	void					PushParameter(parameter_type_t param_type, void *param, int rspOffset = 0);

	void					MoveOntoStack( __int64 val, int offset );
	...
	#define					DbgShout(...) DebugShout(__VA_ARGS__)
	#else
	#define					DbgShout(...)
	#endif
